Public Class Form10
    ...
    Private Sub btnGraph_Click(sender As System.Object, e As System.EventArgs) Handles btnGraph.Click
        ...
        g.DrawLine(penBlue, 65, y - score1, 175, y - score2)
        g.DrawLine(penBlue, 115, y - score2, 225, y - score3)
        g.DrawLine(penBlue, 270, y - score3, 150, y - score4)
        g.DrawLine(penBlue, 320, y - score4, 200, y - score5)
    End Sub
